...
function isShowing(panelview) {
    ...
    // panel.
    return ( MainMenu.isOpen() && MainMenu.view == SUB_VIEW ) ||
            ( !!panelview.panelMultiView &&
              panelview.panelMultiView.hasAttribute("panelopen") &&
              panelview.panelMultiView.showingSubViewAsMainView &&
              panelview.panelMultiView.getAttribute("viewtype") == "main");
};
