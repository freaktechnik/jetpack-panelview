...
function show(panelview, button, window = getMostRecentBrowserWindow()) {
    if(window.document != panelview.ownerDocument) {
        detach(panelview);
    ...
    let buttonView = CustomizableUI.getWidget(buttonId).forWindow(window).node;
