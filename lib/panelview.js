...
const PanelView = Class({
    ...
    setup: function(options) {
        ...
        listeners.forEach((event) => on(element, event, this));
        ...
        models.set(this, { isShowing: false, id: options.id });
    },
    dispose: function() {
        this.hide();

        // clean up event listeners
        listeners.forEach((event) => removeListener(viewFor(this), event, this));
